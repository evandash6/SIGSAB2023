    ...
    (a.dev = !1),
                ...
                l.each(function (l) {
                    function m() {
                        var a = d3.event.clientX - this.getBoundingClientRect().left,
                            ...
                            h = !1;
                        if (
                            (k && ((a = d3.event.offsetX), (d = d3.event.offsetY), "svg" !== d3.event.target.tagName && (e = !1), d3.event.target.className.baseVal.match("nv-legend") && (h = !0)),
                            e && ((a -= c.left), (d -= c.top)),
                            "mouseout" === d3.event.type || 0 > a || 0 > d || a > o || d > p || (d3.event.relatedTarget && void 0 === d3.event.relatedTarget.ownerSVGElement) || h)
                        ) {
                        ...
                        if (i) {
                            ...
                            if (!(f.range()[m] + f.rangeBand() >= a)) return g.elementMouseout({ mouseX: a, mouseY: d }), b.renderGuideLine(null), void j.hidden(!0);
                            l = f.domain()[d3.bisect(f.range(), a) - 1];
                        } else l = f.invert(a);
                        g.elementMousemove({ mouseX: a, mouseY: d, pointXValue: l }),
                            "dblclick" === d3.event.type && g.elementDblclick({ mouseX: a, mouseY: d, pointXValue: l }),
                            "click" === d3.event.type && g.elementClick({ mouseX: a, mouseY: d, pointXValue: l }),
                            "mousedown" === d3.event.type && g.elementMouseDown({ mouseX: a, mouseY: d, pointXValue: l }),
                    ...
                    r.append("g").attr("class", "nv-interactiveGuideLine"),
                        i &&
                            (i.on("touchmove", m).on("mousemove", m, !0).on("mouseout", m, !0).on("mousedown", m, !0).on("mouseup", m, !0).on("dblclick", m).on("click", m),
                            (b.guideLine = null),
        ...
        (a.models.axis = function () {
                            ...
                            case "top":
                                x.enter().append("text").attr("class", "nv-axislabel"),
                                    ...
                                    1 === e.range().length
                                        ...
                                        : 2 === e.range().length
                                        ? (A = n ? e.range()[0] + e.range()[1] + e.rangeBand() : e.range()[1])
                                        : e.range().length > 2 && (A = e.range()[e.range().length - 1] + (e.range()[1] - e.range()[0])),
                                    x
                            ...
                            case "bottom":
                                ...
                                x.enter().append("text").attr("class", "nv-axislabel"),
                                    ...
                                    x
                                        ...
                                        .attr("x", A / 2),
                                    j &&
                                        ((z = r.selectAll("g.nv-axisMaxMin").data([e.domain()[0], e.domain()[e.domain().length - 1]])),
                                        z
                                            .enter()
                                            .append("g")
                                            .attr("class", function (a, b) {
                                        ...
                                        z
                                            ...
                                            .attr("y", d.tickPadding())
                                            .attr("transform", E)
                                            .style("text-anchor", k ? (k % 360 > 0 ? "start" : "end") : "middle")
                                            .text(function (a, b) {
                                                var d = c || w,
                                                    e = d(a);
                                                return ("" + e).match("NaN") ? "" : e;
                            ...
                            !j ||
                                ...
                                (v.selectAll("g").each(function (a, b) {
                                    d3.select(this).select("text").attr("opacity", 1),
                                        (e(a) < e.range()[1] + 10 || e(a) > e.range()[0] - 10) && ((a > 1e-10 || -1e-10 > a) && d3.select(this).attr("opacity", 0), d3.select(this).select("text").attr("opacity", 0));
                                }),
                                e.domain()[0] == e.domain()[1] &&
                                    0 == e.domain()[0] &&
                                    r.selectAll("g.nv-axisMaxMin").style("opacity", function (a, b) {
                                        return b ? 0 : 1;
                                    })),
            ...
            return (
                ...
                a.utils.inheritOptionsD3(b, d, ["orient", "tickValues", "tickSubdivide", "tickSize", "tickPadding", "tickFormat"]),
                a.utils.inheritOptionsD3(b, e, ["domain", "range", "rangeBand", "rangeBands"]),
                b
            );
        }),
            ...
            function c(e) {
                return (
                    e.each(function (c, e) {
                        ...
                        this.__chart__ = H;
                        for (
                            var I = (d3.min(z), d3.max(z), z[1], r.selectAll("g.nv-wrap.nv-bullet").data([c])), J = I.enter().append("g").attr("class", "nvd3 nv-wrap nv-bullet"), K = J.append("g"), L = I.select("g"), e = 0, M = z.length;
                            M > e;
                            e++
                        ) {
                ...
                return (
                    x.each(function (b) {
                        ...
                        l.domain(d || d3.extent(b[0].values.map(n).concat(t))),
                            v ? l.range(f || [(0.5 * x) / b[0].values.length, (x * (b[0].values.length - 0.5)) / b[0].values.length]) : l.range(f || [5 + A / 2, x - A / 2 - 5]),
                            m.domain(e || [d3.min(b[0].values.map(s).concat(u)), d3.max(b[0].values.map(r).concat(u))]).range(g || [y, 0]),
                            l.domain()[0] === l.domain()[1] && (l.domain()[0] ? l.domain([l.domain()[0] - 0.01 * l.domain()[0], l.domain()[1] + 0.01 * l.domain()[1]]) : l.domain([-1, 1])),
                            m.domain()[0] === m.domain()[1] && (m.domain()[0] ? m.domain([m.domain()[0] + 0.01 * m.domain()[0], m.domain()[1] - 0.01 * m.domain()[1]]) : m.domain([-1, 1]));
                ...
                return (
                    ...
                    m.each(function (m) {
                        ...
                        if (
                            ...
                            s
                                ? (j.width(P),
                                  ...
                                  o || j.height() === n.top || ((n.top = j.height()), (Q = a.utils.availableHeight(r, O, n))),
                                  W.select(".nv-legendWrap").attr("transform", "translate(0," + -n.top + ")"))
                                : W.select(".nv-legendWrap").selectAll("*").remove(),
                            w)
                        ) {
                            var X = [{ key: "Re-scale y-axis", disabled: !y }];
                            k.width(140).color(["#444", "#444", "#444"]).rightAlign(!1).margin({ top: 5, right: 0, bottom: 5, left: 20 }),
                        ...
                        U.select(".tempDisabled").remove(),
                            ...
                            x && (l.width(P).height(Q).margin({ left: n.left, top: n.top }).svgContainer(O).xScale(e), U.select(".nv-interactive").call(l)),
                            V.select(".nv-background").append("rect"),
                            W.select(".nv-background rect").attr("width", P).attr("height", Q),
                            g
                                .y(function (a) {
                                    return a.display.y;
                                })
                        ...
                        ba.enter().append("rect").attr("class", "nv-indexLine").attr("width", 3).attr("x", -2).attr("fill", "red").attr("fill-opacity", 0.5).style("pointer-events", "all").call(S),
                            ba
                                .attr("transform", function (a) {
                            ...
                            t &&
                                (h
                                    ...
                                    .tickSize(-Q, 0),
                                W.select(".nv-x.nv-axis").attr("transform", "translate(0," + f.range()[0] + ")"),
                                ...
                                if (
                                    (m
                                        ...
                                        .forEach(function (h, i) {
                                            ...
                                            var k = h.values[e];
                                            "undefined" != typeof k && ("undefined" == typeof d && (d = k), "undefined" == typeof f && (f = b.xScale()(b.x()(k, e))), j.push({ key: h.key, value: b.y()(k, e), color: p(h, h.seriesIndex) }));
                                        }),
                                    j.length > 2)
                                ) {
                            ...
                            E.on("changeState", function (a) {
                                "undefined" != typeof a.disabled &&
                                    ...
                                    "undefined" != typeof a.index && ((J.i = a.index), (J.x = I(J.i)), (A.index = a.index), ba.data([J])),
                ...
                return (
                    ...
                    i.each(function (i) {
                        ...
                        A.append("g").attr("class", "nv-x nv-axis"),
                            A.append("g").attr("class", "nv-y nv-axis").append("g").attr("class", "nv-zeroLine").append("line"),
                            ...
                            o
                                ? (h.width(v),
                                  ...
                                  k || h.height() === j.top || ((j.top = h.height()), (y = a.utils.availableHeight(m, n, j))),
                                  z.select(".nv-legendWrap").attr("transform", "translate(0," + -j.top + ")"))
                                : C.select(".nv-legendWrap").selectAll("*").remove(),
                            r && C.select(".nv-y.nv-axis").attr("transform", "translate(" + v + ",0)"),
                            e.width(v).height(y);
                        ...
                        if (
                            ...
                            f
                                ...
                                .tickSize(-y, 0),
                                C.select(".nv-x.nv-axis").attr("transform", "translate(0," + (d.range()[0] + (e.showValues() && d.domain()[0] < 0 ? 16 : 0)) + ")"),
                ...
                return (
                    ...
                    u.each(function (t) {
                        ...
                        A.attr("transform", "translate(" + i.left + "," + i.top + ")"),
                            ...
                            o && C.select(".nv-y.nv-axis").attr("transform", "translate(" + y + ",0)"),
                            C.select(".nv-background rect").attr("width", y).attr("height", z),
                            b
                                .width(y)
                                .height(z)
                                .color(
                ...
                return (
                    x.each(function (b) {
                        ...
                        a.utils.initSVG(k),
                            ...
                            r ? l.range(e || [(0.5 * x) / b[0].values.length, (x * (b[0].values.length - 0.5)) / b[0].values.length]) : l.range(e || [0, x]),
                        ...
                        E.exit().remove(),
                            E.enter()
                                ...
                                .on("click", function (a, b) {
                                    if (v) {
                                        var c = this;
                                        u.elementClick({ data: a, index: b, color: d3.select(this).style("fill"), event: d3.event, element: c }), d3.event.stopPropagation();
                                    }
                                })
                                .on("dblclick", function (a, b) {
                ...
                return (
                    b.each(function (k) {
                        ...
                        F.append("g").attr("class", "nv-x nv-axis"),
                            ...
                            t && G.select(".nv-y.nv-axis").attr("transform", "translate(" + B + ",0)"),
                            u && (j.width(B).height(C).margin({ left: l.left, top: l.top }).svgContainer(x).xScale(d), E.select(".nv-interactive").call(j)),
                            f
                                .width(B)
                                .height(C)
                                .color(
                        ...
                        H.transition().call(f),
                            ...
                            j.dispatch.on("elementMousemove", function (b) {
                                ...
                                k.filter(function (a, b) {
                                    ...
                                    var j = g.values[e];
                                    void 0 !== j && (void 0 === d && (d = j), void 0 === i && (i = c.xScale()(c.x()(j, e))), l.push({ key: g.key, value: c.y()(j, e), color: n(g, g.seriesIndex), data: g.values[e] }));
                                });
            ...
            function b(s) {
                ...
                return (
                    s.each(function (b) {
                        ...
                        if ("classic" == r) C.append("circle").style("stroke-width", 2).attr("class", "nv-legend-symbol").attr("r", 5), (z = B.select(".nv-legend-symbol"));
                        else if ("furious" == r) {
                            C.append("rect").style("stroke-width", 2).attr("class", "nv-legend-symbol").attr("rx", 3).attr("ry", 3),
                        ...
                        if (j) {
                            ...
                            B.attr("transform", function (a, b) {
                                ...
                                l ? y.attr("transform", "translate(" + (d - c.right - F) + "," + c.top + ")") : y.attr("transform", "translate(0," + c.top + ")"),
                            ...
                            B.attr("transform", function (a, b) {
                                ...
                                y.attr("transform", "translate(" + (d - c.right - Q) + "," + c.top + ")"),
                        ...
                        if ("furious" == r) {
                            z
                                ...
                                .attr("y", -9)
                                .attr("x", -15),
                                x.insert("rect", ":first-child").attr("class", "nv-legend-bg").attr("fill", "#eee").attr("opacity", 0);
                    ...
                    j.each(function (j) {
                        ...
                        q
                            ? (h.width(H),
                              ...
                              "bottom" === r
                                  ? ((l.bottom = f.height() + h.height()), (I = a.utils.availableHeight(p, G, l)), M.select(".nv-legendWrap").attr("transform", "translate(0," + (I + f.height()) + ")"))
                                  : "top" === r &&
                                    (m || h.height() === l.top || ((l.top = h.height()), (I = a.utils.availableHeight(p, G, l) - (w ? k.height() : 0))), K.select(".nv-legendWrap").attr("transform", "translate(0," + -l.top + ")")))
                            : M.select(".nv-legendWrap").selectAll("*").remove(),
                            K.attr("transform", "translate(" + l.left + "," + l.top + ")"),
                            u && M.select(".nv-y.nv-axis").attr("transform", "translate(" + H + ",0)"),
                            v && (i.width(H).height(I).margin({ left: l.left, top: l.top }).svgContainer(G).xScale(c), K.select(".nv-interactive").call(i)),
                            M.select(".nv-focus .nv-background rect").attr("width", H).attr("height", I),
                            e
                                .width(H)
                                .height(I)
                                .color(
                        ...
                        if (
                            ...
                            k.width(H),
                                M.select(".nv-focusWrap")
                                    ...
                                    .attr("transform", "translate(0," + (I + l.bottom + k.margin().top) + ")")
                                    .call(k);
                                    ...
                                    (j
                                        ...
                                        .forEach(function (g, i) {
                                            ...
                                            null !== q && e.highlightPoint(i, h, !0),
                                                void 0 !== p && (void 0 === f && (f = p), void 0 === l && (l = b.xScale()(b.x()(p, h))), m.push({ key: g.key, value: q, color: n(g, g.seriesIndex), data: p }));
                                        }),
                                    m.length > 2)
                                ) {
                    ...
                    v.each(function (v) {
                        ...
                        function T() {
                            ...
                            (d = aa.length && !R ? l.xScale() : j.xScale()),
                                ...
                                ga.select(".nv-focus .nv-x.nv-axis").attr("transform", "translate(0," + f.range()[0] + ")"),
                                p
                                    .scale(f)
                            ...
                            ga.select(".nv-focus .nv-y1.nv-axis").style("opacity", m),
                                ...
                                ga.select(".nv-focus .nv-y1.nv-axis").transition().duration(M).call(p),
                                ga.select(".nv-focus .nv-y2.nv-axis").transition().duration(M).call(q);
                        }
                        var X = d3.select(this);
                        a.utils.initSVG(X);
                        ...
                        if (
                            ...
                            t.width(ja),
                                ga
                                    ...
                                    .call(t),
                                x || t.height() === w.top || ((w.top = t.height()), (Z = a.utils.availableHeight(A, X, w) - I)),
                    ...
                    F.each(function (b) {
                        ...
                        m
                            ...
                            n
                                ...
                                .range(g || [G, 0]),
                            m.domain()[0] === m.domain()[1] && (m.domain()[0] ? m.domain([m.domain()[0] - 0.01 * m.domain()[0], m.domain()[1] + 0.01 * m.domain()[1]]) : m.domain([-1, 1])),
                            n.domain()[0] === n.domain()[1] && (n.domain()[0] ? n.domain([n.domain()[0] + 0.01 * n.domain()[0], n.domain()[1] - 0.01 * n.domain()[1]]) : n.domain([-1, 1])),
                            (h = h || m),
                            (i = i || n);
                        ...
                        R.style("fill", function (a, b, c) {
                            ...
                            .on("click", function (a, c, d) {
                                var e = this;
                                C.elementClick({ data: a, index: c, series: b[d], color: d3.select(this).style("fill"), event: d3.event, element: e }), d3.event.stopPropagation();
                            })
                            .on("dblclick", function (a, c, d) {
                                C.elementDblClick({ data: a, index: c, series: b[d], color: d3.select(this).style("fill") }), d3.event.stopPropagation();
                            }),
                ...
                return (
                    ...
                    D.each(function (D) {
                            ...
                            s
                                ? "bottom" === t
                                    ? (i.width(M - l.right),
                                      ...
                                      (N = a.utils.availableHeight(o, I, l)),
                                      R.select(".nv-legendWrap").attr("transform", "translate(0," + (N + f.height()) + ")"))
                                    : (i.width(M - F()),
                                      R.select(".nv-legendWrap").datum(D).call(i),
                                      m || i.height() === l.top || ((l.top = i.height()), (N = a.utils.availableHeight(o, I, l))),
                                      R.select(".nv-legendWrap").attr("transform", "translate(" + F() + "," + -l.top + ")"))
                        ...
                        P.attr("transform", "translate(" + l.left + "," + l.top + ")"),
                            w && R.select(".nv-y.nv-axis").attr("transform", "translate(" + M + ",0)"),
                            e
                                .disabled(
                                    D.map(function (a) {
                                        return a.disabled;
                        ...
                        if ((T.call(e), u)) {
                            f
                                ...
                                .tickSize(-N, 0),
                                R.select(".nv-x.nv-axis").attr("transform", "translate(0," + d.range()[0] + ")"),
                            ...
                            z && R.selectAll(".tick text").call(a.utils.wrapTicks, b.xAxis.rangeBand()),
                                x &&
                                ...
                                R.select(".nv-x.nv-axis").selectAll("g.nv-axisMaxMin text").style("opacity", 1);
                        }
                        v &&
                            (g
                                .scale(d)
                            ...
                            H && (h.width(M).height(N).margin({ left: l.left, top: l.top }).svgContainer(I).xScale(c), P.select(".nv-interactive").call(h)),
                            ...
                            E.on("changeState", function (a) {
                                "undefined" != typeof a.disabled &&
                                    ...
                                    "undefined" != typeof a.stacked && (e.stacked(a.stacked), (B.stacked = a.stacked), (J = a.stacked)),
                                    b.update();
                            }),
                            H
                                ? (h.dispatch.on("elementMousemove", function (a) {
                                      if (void 0 != a.pointXValue) {
                                          ...
                                          D.filter(function (a, b) {
                                              ...
                                              var k = h.values[e];
                                              void 0 !== k && ((g = k.x), void 0 === d && (d = k), void 0 === f && (f = a.mouseX), i.push({ key: h.key, value: b.y()(k, e), color: p(h, h.seriesIndex), data: h.values[e] }));
                                          }),
                    ...
                    m.each(function (b) {
                        ...
                        M.append("rect")
                            ...
                            L.on("mouseover", function (a, b) {
                                ...
                                .on("click", function (a, b) {
                                    var c = this;
                                    E.elementClick({ data: a, index: b, color: d3.select(this).style("fill"), event: d3.event, element: c }), d3.event.stopPropagation();
                                })
                                .on("dblclick", function (a, b) {
                    ...
                    j.each(function (j) {
                        ...
                        if (
                            ...
                            s
                                ? (h.width(F - B()),
                                  ...
                                  "bottom" === t
                                      ? ((k.bottom = f.height() + h.height()), (G = a.utils.availableHeight(n, z, k)), K.select(".nv-legendWrap").attr("transform", "translate(" + B() + "," + (G + f.height()) + ")"))
                                      : "top" === t && (l || h.height() === k.top || ((k.top = h.height()), (G = a.utils.availableHeight(n, z, k))), K.select(".nv-legendWrap").attr("transform", "translate(" + B() + "," + -k.top + ")")))
                                ...
                                "bottom" === q
                                    ? ((k.bottom = f.height() + h.height()),
                                      ...
                                      K.select(".nv-controlsWrap")
                                          .datum(L)
                                          .attr("transform", "translate(0," + (G + f.height()) + ")")
                                          .call(i))
                                    : "top" === q &&
                                      K.select(".nv-controlsWrap")
                                          .datum(L)
                        ...
                        v &&
                            (g
                                ...
                                .tickSize(-G, 0),
                            K.select(".nv-y.nv-axis").attr("transform", "translate(0," + G + ")"),
                            K.select(".nv-y.nv-axis").call(g)),
                            K.select(".nv-zeroLine line").attr("x1", d(0)).attr("x2", d(0)).attr("y1", 0).attr("y2", -G),
                            h.dispatch.on("stateChange", function (a) {
                                for (var c in a) x[c] = a[c];
                                A.stateChange(x), b.update();
                            }),
                            ...
                            A.on("changeState", function (a) {
                                "undefined" != typeof a.disabled &&
                                    ...
                                    (x.disabled = a.disabled)),
                                    "undefined" != typeof a.stacked && (e.stacked(a.stacked), (x.stacked = a.stacked), (w = a.stacked)),
                                    b.update();
                            });
                    }),
                ...
                return (
                    k.each(function (k) {
                        ...
                        function L(a) {
                            var b = 2 === a.series.yAxis ? G : F;
                            (a.value = A.x()(a.data)),
                                (a.series = { value: A.y()(a.data), color: a.color, key: a.data.key }),
                                I.duration(0)
                                    .headerFormatter(function (a, b) {
                                        return E.tickFormat()(a, b);
                                    })
                        ...
                        if (j) {
                            ...
                            H.width(da),
                                ...
                                ba
                                    ...
                                    .call(H),
                                f || H.height() === e.top || ((e.top = H.height()), (Q = a.utils.availableHeight(i, O, e))),
                        ...
                        W.length && oa.push({ x: 0, y: 0 }),
                            ...
                            ba.select(".nv-x.nv-axis").attr("transform", "translate(0," + Q + ")"),
                            ...
                            q && (p.width(P).height(Q).margin({ left: e.left, top: e.top }).svgContainer(O).xScale(t), _.select(".nv-interactive").call(p)),
                            q
                                ? (p.dispatch.on("elementMousemove", function (c) {
                                      ...
                                      k.filter(function (a, b) {
                                          ...
                                          var m = l[e],
                                              n = b.y()(m, e);
                                          null !== n && N(j, e, !0),
                                              void 0 !== m && (void 0 === d && (d = m), void 0 === f && (f = t(b.x()(m, e))), h.push({ key: i.key, value: n, color: g(i, i.seriesIndex), data: m, yAxis: 2 == i.yAxis ? G : F }));
                                      });
                                      var i = function (a, b) {
                                          var c = h[b].yAxis;
                ...
                return (
                    y.each(function (b) {
                        ...
                        l.domain(c || d3.extent(b[0].values.map(n).concat(t))),
                            v ? l.range(e || [(0.5 * y) / b[0].values.length, (y * (b[0].values.length - 0.5)) / b[0].values.length]) : l.range(e || [5 + B / 2, y - B / 2 - 5]),
                        ...
                        function F() {
                            e.select(".nv-axis").each(function (a, b) {
                                ...
                                (P[a.key] = l[a.key].domain()),
                                    0 != c.length && q && ((P[a.key] = []), c[0].extent[1] > l[a.key].domain()[0] && (P[a.key] = [c[0].extent[1]]), c[0].extent[0] >= l[a.key].domain()[0] && P[a.key].push(c[0].extent[0])),
                            ...
                            j
                                ? (d.width(p).color(function (a) {
                                  ...
                                  x
                                      ...
                                      .call(d),
                                  g || d.height() === f.top || ((f.top = d.height()), (q = a.utils.availableHeight(i, k, f))),
                                  v.select(".nv-legendWrap").attr("transform", "translate( 0 ," + -f.top + ")"))
                ...
                c.dispatch.on("elementMouseover.tooltip", function (a) {
                    ...
                    a.values &&
                        (Object.keys(a.values).forEach(function (c) {
                            ...
                            if (d) {
                                var e;
                                (e = isNaN(a.values[c]) || isNaN(parseFloat(a.values[c])) ? q : d.format(a.values[c])), b.series.push({ idx: d.currentPosition, key: c, value: e, color: d.color });
                            }
                        }),
                ...
                return (
                    ...
                    G.each(function (b) {
                        ...
                        var H = d - c.left - c.right,
                            ...
                            K = [],
                            L = [];
                        if (((i = d3.select(this)), 0 === B.length)) for (var M = J - J / 10, N = z * J, O = 0; O < b[0].length; O++) K.push(M), L.push(N);
                        else
                            s
                                ? ((K = B.map(function (a) {
                        ...
                        R.append("g").attr("class", "nv-pieLabels"),
                            ...
                            S.select(".nv-pie").attr("transform", "translate(" + H / 2 + "," + I / 2 + ")"),
                            S.select(".nv-pieLabels").attr("transform", "translate(" + H / 2 + "," + I / 2 + ")"),
                        ...
                        W.padAngle && w && W.padAngle(w),
                            q &&
                                ...
                                P.select(".nv-pie-title")
                                    ...
                                    .style("font-size", (Math.min(H, I) * z * 2) / (r.length + 2) + "px")
                                    .attr("dy", "0.35em")
                                    .attr("transform", function (a, b) {
                        ...
                        Z.attr("class", "nv-slice"),
                            Z.on("mouseover", function (a, b) {
                                d3.select(this).classed("hover", !0),
                                    s && d3.select(this).select("path").transition().duration(70).attr("d", E[b]),
                                    C.elementMouseover({ data: a.data, index: b, color: d3.select(this).style("fill"), percent: (a.endAngle - a.startAngle) / (2 * Math.PI) });
                            }),
                            Z.on("mouseout", function (a, b) {
                                d3.select(this).classed("hover", !1), s && d3.select(this).select("path").transition().duration(50).attr("d", D[b]), C.elementMouseout({ data: a.data, index: b });
                            }),
                            ...
                            Z.on("click", function (a, b) {
                                var c = this;
                                C.elementClick({ data: a.data, index: b, color: d3.select(this).style("fill"), event: d3.event, element: c });
                            }),
                        ...
                        if (
                            ...
                            for (var $ = [], O = 0; O < b[0].length; O++)
                                $.push(D[O]), m ? q && (($[O] = d3.svg.arc().outerRadius(D[O].outerRadius())), v !== !1 && $[O].startAngle(v), x !== !1 && $[O].endAngle(x)) : q || $[O].innerRadius(0);
                            Y.enter()
                                .append("g")
                                .classed("nv-label", !0)
                                .each(function (a, b) {
                                    ...
                                    c.attr("transform", function (a, b) {
                                        ...
                                        c
                                            .append("text")
                                            .style("text-anchor", u ? ((a.startAngle + a.endAngle) / 2 < Math.PI ? "start" : "end") : "middle")
                                            .style("fill", "#000");
                                });
                            var _ = {},
                                aa = 14,
                        ...
                        if ((v.append("g").attr("class", "nv-pieWrap"), v.append("g").attr("class", "nv-legendWrap"), k))
                            if ("top" === l)
                                d.width(m).key(c.x()),
                                    ...
                                    s.select(".nv-legendWrap").attr("transform", "translate(0," + -f.top + ")");
                            else if ("right" === l) {
                                ...
                                "bottom" === l &&
                                    ...
                                    (f.bottom = d.height()),
                                    (p = a.utils.availableHeight(i, j, f)),
                                    s.select(".nv-legendWrap").attr("transform", "translate(0," + p + ")"));
                ...
                return (
                    a.each(function (b) {
                        ...
                        var i = {
                            ...
                            k = !1,
                            l = !1;
                        if ((("object" == typeof b.nodes && b.nodes.length) >= 0 && ("object" == typeof b.links && b.links.length) >= 0 && (k = !0), b.nodes && b.nodes.length > 0 && b.links && b.links.length > 0 && (l = !0), !k))
                            return console.error("NVD3 Sankey chart error:", "invalid data format for", b), console.info("Valid data format is: ", i, JSON.stringify(i)), r(a, "Error loading chart, data is invalid"), !1;
                    ...
                    b.each(function (b) {
                        function V() {
                            ...
                            if (U === !0) {
                                ...
                                if ((K && i.style("fill", d3.rgb(230, 230, 230)).style("fill-opacity", 0.4).style("stroke-opacity", 1).style("stroke", d3.rgb(200, 200, 200)), J)) {
                                ...
                                ha.select(".nv-groups")
                                    ...
                                    .on("dblclick", function (a, c) {
                                        ...
                                        var d = b[a.series],
                                            e = d.values[c];
                                        T.elementDblClick({ point: e, series: d, pos: [u(x(e, c)) + n.left, v(y(e, c)) + n.top], relativePos: [u(x(e, c)) + n.left, v(y(e, c)) + n.top], seriesIndex: a.series, pointIndex: c });
                                    })
                        ...
                        if (
                            ...
                            G && b[0] ? u.range(O || [(_ * H + _) / (2 * b[0].values.length), _ - (_ * (1 + H)) / (2 * b[0].values.length)]) : u.range(O || [0, _]),
                            ba)
                        ) {
                            var da = d3.min(
                                ca.map(function (a) {
                        ...
                        w
                            ...
                            .range(R || $),
                            (S = u.domain()[0] === u.domain()[1] || v.domain()[0] === v.domain()[1]),
                            u.domain()[0] === u.domain()[1] && (u.domain()[0] ? u.domain([u.domain()[0] - 0.01 * u.domain()[0], u.domain()[1] + 0.01 * u.domain()[1]]) : u.domain([-1, 1])),
                            v.domain()[0] === v.domain()[1] && (v.domain()[0] ? v.domain([v.domain()[0] - 0.01 * v.domain()[0], v.domain()[1] + 0.01 * v.domain()[1]]) : v.domain([-1, 1])),
                        ...
                        ma.enter().append("g").style("stroke-opacity", 1e-6).style("fill-opacity", 1e-6),
                            ma.exit().remove(),
                            ma
                                .attr("class", function (a, b) {
                                    return (a.classed || "") + " nv-group nv-series-" + b;
                        ...
                        if (
                            ...
                            oa
                                ...
                                oa.watchTransition(Z, "scatter labels").attr("transform", function (b) {
                                    var c = a.utils.NaNtoZero(u(x(b[0], b[1]))) + Math.sqrt(w(z(b[0], b[1])) / Math.PI) + 2;
                                    return "translate(" + c + "," + a.utils.NaNtoZero(v(y(b[0], b[1]))) + ")";
                                });
                        }
                ...
                return (
                    ...
                    A.each(function (A) {
                        ...
                        var L = n.selectAll("g.nv-wrap.nv-scatterChart").data([A]),
                            ...
                            O = L.select("g");
                        if (
                            (N.append("rect").attr("class", "nvd3 nv-background").style("pointer-events", "none"),
                            N.append("g").attr("class", "nv-x nv-axis"),
                            N.append("g").attr("class", "nv-y nv-axis"),
                            ...
                            w && O.select(".nv-y.nv-axis").attr("transform", "translate(" + I + ",0)"),
                            t)
                        ) {
                            var P = I;
                            f.width(P),
                                L.select(".nv-legendWrap").datum(A).call(f),
                                k || f.height() === j.top || ((j.top = f.height()), (J = a.utils.availableHeight(m, n, j))),
                                L.select(".nv-legendWrap").attr("transform", "translate(0," + -j.top + ")");
                        ...
                        L.attr("transform", "translate(" + j.left + "," + j.top + ")"),
                            ...
                            L.select(".nv-scatterWrap")
                                ...
                                .call(c),
                            L.select(".nv-regressionLinesWrap").attr("clip-path", "url(#nv-edge-clip-" + c.id() + ")");
                        ...
                        R.enter().append("line").attr("class", "nv-regLine").style("stroke-opacity", 0),
                            ...
                            r &&
                                ...
                                N.select(".nv-distWrap").append("g").attr("class", "nv-distributionX"),
                            ...
                            s &&
                                ...
                                N.select(".nv-distWrap").append("g").attr("class", "nv-distributionY"),
                            ...
                            c.dispatch.on("elementMouseout.tooltip", function (a) {
                                i.hidden(!0),
                                    n.select(".nv-chart-" + c.id() + " .nv-series-" + a.seriesIndex + " .nv-distx-" + a.pointIndex).attr("y1", 0),
                    ...
                    k.each(function (k) {
                        ...
                        if (s) {
                            ...
                            if ((h.width(Z), X.select(".nv-legendWrap").datum(k).call(h), "bottom" === t)) {
                                ...
                                "top" === t &&
                                    (n || m.top == h.height() || ((m.top = h.height()), (T = a.utils.availableHeight(p, R, m) - (x ? l.height() : 0))),
                                    X.select(".nv-legendWrap").attr("transform", "translate(" + (S - Z) + "," + -m.top + ")"));
                        } else X.select(".nv-legendWrap").selectAll("*").remove();
                        if (r) {
                            var aa = [
                                { key: H.stacked || "Stacked", metaKey: "Stacked", disabled: "stack" != e.style(), style: "stack" },
                                { key: H.stream || "Stream", metaKey: "Stream", disabled: "stream" != e.style(), style: "stream" },
                                { key: H.expanded || "Expanded", metaKey: "Expanded", disabled: "expand" != e.style(), style: "expand" },
                                { key: H.stack_percent || "Stack %", metaKey: "Stack_Percent", disabled: "stack_percent" != e.style(), style: "stack_percent" },
                            ];
                            (F = (G.length / 3) * 260),
                        ...
                        V.attr("transform", "translate(" + m.left + "," + m.top + ")"),
                            w && X.select(".nv-y.nv-axis").attr("transform", "translate(" + S + ",0)"),
                            y && (j.width(S).height(T).margin({ left: m.left, top: m.top }).svgContainer(R).xScale(c), V.select(".nv-interactive").call(j)),
                            X.select(".nv-focus .nv-background rect").attr("width", S).attr("height", T),
                            e
                                .width(S)
                                .height(T)
                                .color(
                        ...
                        if (x) {
                            l.width(S),
                                X.select(".nv-focusWrap")
                                    .attr("transform", "translate(0," + (T + m.bottom + l.margin().top) + ")")
                                    .datum(
                                        k.filter(function (a) {
                                            return !a.disabled;
                                        })
                        ...
                        e.dispatch.on("areaClick.toggle", function (a) {
                            ...
                            j.dispatch.on("elementMousemove", function (c) {
                                    ...
                                    (k
                                        ...
                                        .forEach(function (j, n) {
                                            ...
                                            if ((null != p && p > 0 && (e.highlightPoint(n, f, !0), (m = !0)), n !== k.length - 1 || m || e.highlightPoint(n, f, !0), "undefined" != typeof o)) {
                                                ...
                                                h.push({ key: j.key, value: r, color: q(j, j.seriesIndex), point: o }), z && "expand" != e.style() && null != r && ((i += r), (l = !1));
                                            }
                                        }),
                                    h.reverse(),
                                    h.length > 2)
                                ...
                                "expand" === e.style() || "stack_percent" === e.style() ? (K || (K = r), (r = d3.format(".1%"))) : K && ((r = K), (K = null)),
                            ...
                            E.on("changeState", function (a) {
                                "undefined" != typeof a.disabled &&
                                    ...
                                    (B.disabled = a.disabled)),
                                    "undefined" != typeof a.style && (e.style(a.style), (M = a.style)),
                                    b.update();
                            });
                    }),
                ...
                return (
                    ...
                    f.each(function (f) {
                        ...
                        z
                            ...
                            .on("mouseover", function (a, b) {
                                d3.select(this).classed("hover", !0).style("opacity", 0.8), E.elementMouseover({ data: a, color: d3.select(this).style("fill"), percent: d(a) });
                            })
                            .on("mouseout", function (a, b) {
                ...
                return (
                    ...
                    d.each(function (d) {
                        ...
                        return (
                            ...
                            (b.container = h),
                            d && d.length ? (h.selectAll(".nv-noData").remove(), c.width(i).height(j).margin(e), void h.call(c)) : (a.utils.noData(b, h), b)
                        );
                    }),
