(function () {
    ...
    (X = Error),
        ...
        (D = function () {
            ...
            return (
                ...
                (r = t.request),
                (i = t.url),
                $(i) || _.running || (!1 === A.restartOnRequestAfter && "force" !== H(a))
                    ? void 0
                    : ((o = arguments),
            ...
            return (
                ...
                (f = O(function (t, e) {
                    ...
                    for (y.progress, n = u = 0, s = !0, a = d = 0, f = R.length; d < f; a = ++d)
                        for (L = R[a], c = null != M[a] ? M[a] : (M[a] = []), l = p = 0, g = (r = null != (m = L.elements) ? m : [L]).length; p < g; l = ++p)
    ...
    (function (t, e) {
                            ...
                            (n = t[e]),
                                "__proto__" !== e &&
                                    ...
                                    (h && n && (D.isPlainObject(n) || (s = Array.isArray(n)))
                                        ? ((i = r[e]), (o = s && !Array.isArray(i) ? [] : s || D.isPlainObject(i) ? i : {}), (s = !1), (r[e] = D.extend(h, o, n)))
                                        : void 0 !== n && (r[e] = n));
                return r;
            }),
            D.extend({
                        ...
                        (p.qsa = tt.test(x.querySelectorAll)) &&
                            (ct(function (t) {
                                (a.appendChild(t).innerHTML = "<a id='" + D + "'></a><select id='" + D + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                    ...
                                    t.querySelectorAll("[selected]").length || m.push("\\[" + W + "*(?:value|" + R + ")"),
                            ...
                            : function (t, e, i) {
                                  ...
                                  if (c) {
                                      ...
                                      if (((l = [_ ? c.firstChild : c.lastChild]), _ && d)) {
                                          for (
                                              p = (a = (n = (s = (o = (r = c)[D] || (r[D] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === T && n[1]) && n[2], r = a && c.childNodes[a];
                                          ...
                                          for (
                                              ;
                                              (r = (++a && r && r[h]) || (p = a = 0) || l.pop()) &&
                                              ((b ? r.nodeName.toLowerCase() !== u : 1 !== r.nodeType) || !++p || (d && ((s = (o = r[D] || (r[D] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] = [T, p]), r !== t));
        ...
        (D.fn.ready = function (t) {
            ...
            (D.ready.then = F.then),
            "complete" === k.readyState || ("loading" !== k.readyState && !k.documentElement.doScroll) ? x.setTimeout(D.ready) : (k.addEventListener("DOMContentLoaded", j), x.addEventListener("load", j));
        ...
        function lt(t, e, i, n) {
            ...
            if (c && c[3] !== h) {
                for (l /= 2, h = h || c[3], c = +l || 1; r--; ) D.style(t, e, c + h), (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 && (r = 0), (c /= o);
        ...
        function ct(t, e) {
            for (var i, n, s, o, r, a, l = [], h = 0, c = t.length; h < c; h++)
                (n = t[h]).style &&
                    ((i = n.style.display),
                    e
                        ? ("none" === i && ((l[h] = X.get(n, "display") || null), l[h] || (n.style.display = "")),
                          "" === n.style.display &&
                              rt(n) &&
                              (l[h] =
                                  ((a = o = s = void 0),
                                  (o = n.ownerDocument),
                                  (r = n.nodeName),
                                  (a = ht[r]) || ((s = o.body.appendChild(o.createElement(r))), (a = D.css(s, "display")), s.parentNode.removeChild(s), "none" === a && (a = "block"), (ht[r] = a)))))
        ...
        (D.event = {
                    ...
                    for (
                        ...
                        (p = g = (a = xt.exec(t[h]) || [])[1]),
                            ...
                            p &&
                                ...
                                (u = D.event.special[p] || {}),
                                (c = D.extend({ type: p, origType: g, data: n, handler: i, guid: i.guid, selector: s, needsContext: s && D.expr.match.needsContext.test(s), namespace: f.join(".") }, o)),
                ...
                if (m && (l = m.events)) {
                    for (h = (e = (e || "").match($) || [""]).length; h--; )
                        if (((p = g = (a = xt.exec(e[h]) || [])[1]), (f = (a[2] || "").split(".").sort()), p)) {
                            for (u = D.event.special[p] || {}, d = l[(p = (n ? u.delegateType : u.bindType) || p)] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = o = d.length; o--; )
                                (c = d[o]),
                                    (!s && g !== c.origType) ||
                                        (i && i.guid !== c.guid) ||
            ...
            dispatch: function (t) {
                ...
                if (((a.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, a))) {
                    for (r = D.event.handlers.call(this, a, h), e = 0; (s = r[e++]) && !a.isPropagationStopped(); )
                        for (a.currentTarget = s.elem, i = 0; (o = s.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                            (a.rnamespace && !1 !== o.namespace && !a.rnamespace.test(o.namespace)) ||
                                ((a.handleObj = o), (a.data = o.data), void 0 !== (n = ((D.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, l)) && !1 === (a.result = n) && (a.preventDefault(), a.stopPropagation()));
            ...
            (D.Event = function (t, e) {
                ...
                t && t.type
                    ? ((this.originalEvent = t),
                      (this.type = t.type),
                      (this.isDefaultPrevented = t.defaultPrevented || (void 0 === t.defaultPrevented && !1 === t.returnValue) ? kt : Dt),
            ...
            D.each({ mouseenter: "mouseover", mouseleave: "mouseout", pointerenter: "pointerover", pointerleave: "pointerout" }, function (t, s) {
                D.event.special[t] = {
                    delegateType: s,
                    bindType: s,
                    handle: function (t) {
        ...
        function Lt(i, n, s, o) {
            ...
            if (u && ((e = (t = yt(n, i[0].ownerDocument, !1, i, o)).firstChild), 1 === t.childNodes.length && (t = e), e || o)) {
                ...
                if (a)
                    for (h = r[r.length - 1].ownerDocument, D.map(r, $t), c = 0; c < a; c++)
                        (l = r[c]),
                            pt.test(l.type || "") &&
                                !X.access(l, "globalEval") &&
                                D.contains(h, l) &&
                                (l.src && "module" !== (l.type || "").toLowerCase() ? D._evalUrl && !l.noModule && D._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }) : y(l.textContent.replace(Nt, ""), l, h));
            }
            return i;
        }
        function Rt(t, e, i) {
        ...
        D.extend({
            ...
            D.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function (t, r) {
                D.fn[t] = function (t) {
        ...
        function Xt(t, e, i) {
            ...
            return (
                (i = i || Kt(t)) &&
                    ("" !== (r = i.getPropertyValue(e) || i[e]) || st(t) || (r = D.style(t, e)),
        ...
        function le(t, e, i, n, s, o) {
            ...
            for (; r < 4; r += 2)
                "margin" === i && (l += D.css(t, i + it[r], !0, s)),
                    n
                        ? ("content" === i && (l -= D.css(t, "padding" + it[r], !0, s)), "margin" !== i && (l -= D.css(t, "border" + it[r] + "Width", !0, s)))
                        : ((l += D.css(t, "padding" + it[r], !0, s)), "padding" !== i ? (l += D.css(t, "border" + it[r] + "Width", !0, s)) : (a += D.css(t, "border" + it[r] + "Width", !0, s)));
        ...
        function he(t, e, i) {
            ...
            return (
                ((!_.boxSizingReliable() && s) || "auto" === r || (!parseFloat(r) && "inline" === D.css(t, "display", !1, n))) &&
                    t.getClientRects().length &&
                    ((s = "border-box" === D.css(t, "boxSizing", !1, n)), (o = a in t) && (r = t[a])),
        ...
        D.extend({
            ...
            style: function (t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    "string" == (o = typeof i) && (s = et.exec(i)) && s[1] && ((i = lt(t, e, s)), (o = "number")),
                        null != i &&
                            i == i &&
                            ("number" !== o || l || (i += (s && s[3]) || (D.cssNumber[a] ? "" : "px")),
            ...
            css: function (t, e, i, n) {
                ...
                return (
                    se.test(e) || (e = ie(a)),
                    (r = D.cssHooks[e] || D.cssHooks[a]) && "get" in r && (s = r.get(t, !0, i)),
                    void 0 === s && (s = Xt(t, e, n)),
            ...
            D.each(["height", "width"], function (t, l) {
                D.cssHooks[l] = {
                    get: function (t, e, i) {
                        if (e)
                            return !ne.test(D.css(t, "display")) || (t.getClientRects().length && t.getBoundingClientRect().width)
                                ? he(t, l, i)
                                : at(t, oe, function () {
                                      return he(t, l, i);
                                  });
                    ...
                    set: function (t, e, i) {
                        ...
                        return (
                            ...
                            a && (n = et.exec(e)) && "px" !== (n[3] || "px") && ((t.style[l] = e), (e = D.css(t, l))),
                            ae(0, e, a)
                        );
                    },
                };
            ...
            (((D.Tween = ce).prototype = {
                ...
                run: function (t) {
                    ...
                    return (
                        this.options.duration ? (this.pos = e = D.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration)) : (this.pos = e = t),
        ...
        (D.Animation = D.extend(we, {
                ...
                function (t, e, i) {
                    ...
                    if ((l = !D.isEmptyObject(e)) || !D.isEmptyObject(p))
                        for (n in (u &&
                            ...
                            "none" === (c = D.css(t, "display")) && (h ? (c = h) : (ct([t], !0), (h = t.style.display || h), (c = D.css(t, "display")), ct([t]))),
            ...
            (D.speed = function (t, e, i) {
                var n = t && "object" == typeof t ? D.extend({}, t) : { complete: i || (!i && e) || (b(t) && t), duration: t, easing: (i && e) || (e && !b(e) && e) };
                return (
                    D.fx.off ? (n.duration = 0) : "number" != typeof n.duration && (n.duration in D.fx.speeds ? (n.duration = D.fx.speeds[n.duration]) : (n.duration = D.fx.speeds._default)),
            ...
            D.each({ slideDown: be("show"), slideUp: be("hide"), slideToggle: be("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (t, n) {
                ...
                attr: function (t, e, i) {
                    ...
                    if (3 !== o && 8 !== o && 2 !== o)
                        return void 0 === t.getAttribute
                            ? D.prop(t, e, i)
                            : ((1 === o && D.isXMLDoc(t)) || (s = D.attrHooks[e.toLowerCase()] || (D.expr.match.bool.test(e) ? Ce : void 0)),
                              void 0 !== i
                                  ? null === i
        ...
        D.fn.extend({
            ...
            D.extend({
                prop: function (t, e, i) {
                    ...
                    if (3 !== o && 8 !== o && 2 !== o)
                        return (
                            (1 === o && D.isXMLDoc(t)) || ((e = D.propFix[e] || e), (s = D.propHooks[e])),
            ...
            D.fn.extend({
                ...
                toggleClass: function (s, e) {
                    ...
                    return "boolean" == typeof e && r
                        ...
                        : this.each(function () {
                              var t, e, i, n;
                              if (r) for (e = 0, i = D(this), n = Ee(s); (t = n[e++]); ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
        ...
        D.fn.extend({
            val: function (i) {
                ...
                return arguments.length
                    ...
                    : e
                    ? (n = D.valHooks[e.type] || D.valHooks[e.nodeName.toLowerCase()]) && "get" in n && void 0 !== (t = n.get(e, "value"))
                        ? t
            ...
            trigger: function (t, e, i, n) {
                ...
                if (
                    ...
                    3 !== i.nodeType &&
                        ...
                        (l = p.indexOf(":") < 0 && "on" + p),
                        ((t = t[D.expando] ? t : new D.Event(p, "object" == typeof t && t)).isTrigger = n ? 2 : 3),
                        (t.namespace = f.join(".")),
        ...
        (Xe.href = Ne.href),
            D.extend({
                ...
                ajax: function (t, e) {
                    ...
                    for (s in ((g = D.event && m.global) && 0 == D.active++ && D.event.trigger("ajaxStart"),
                    ...
                    m.hasContent
                        ...
                        : ((o = m.url.slice(u.length)),
                          ...
                          (m.url = u + o)),
                    m.ifModified && (D.lastModified[u] && C.setRequestHeader("If-Modified-Since", D.lastModified[u]), D.etag[u] && C.setRequestHeader("If-None-Match", D.etag[u])),
                    ...
                    function h(t, e, i, n) {
                        ...
                        f ||
                            ...
                            s
                                ? (m.ifModified && ((l = C.getResponseHeader("Last-Modified")) && (D.lastModified[u] = l), (l = C.getResponseHeader("etag")) && (D.etag[u] = l)),
                            ...
                            y.fireWith(v, [C, h]),
                            g && (_.trigger("ajaxComplete", [C, m]), --D.active || D.event.trigger("ajaxStop")));
                    }
                    return C;
                },
            ...
            D.each(["get", "post"], function (t, s) {
                D[s] = function (t, e, i, n) {
                    return b(e) && ((n = n || i), (i = e), (e = void 0)), D.ajax(D.extend({ url: t, type: s, dataType: n, data: e, success: i }, D.isPlainObject(t) && t));
                };
            }),
            ...
            (D.parseHTML = function (t, e, i) {
                return "string" != typeof t
                    ...
                    : ("boolean" == typeof e && ((i = e), (e = !1)),
                      ...
                      (o = !i && []),
                      (s = E.exec(t)) ? [e.createElement(s[1])] : ((s = yt([t], e, o)), o && o.length && D(o).remove(), D.merge([], s.childNodes)));
                var n, s, o;
            }),
                            ...
                            for (
                                ...
                                for (S += "<tr>", H = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(M) + "</td>" : "", w = 0; w < 7; w++)
                                    (L = m ? m.apply(t.input ? t.input[0] : null, [M]) : [!0, ""]),
                                        (W = ((R = M.getMonth() !== Z) && !_) || !L[0] || (G && M < G) || (J && J < M)),
                                        (H +=
                                            "<td class='" +
                                            (5 <= (w + c + 6) % 7 ? " ui-datepicker-week-end" : "") +
                                            (R ? " ui-datepicker-other-month" : "") +
                                            ((M.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent) || (b.getTime() === M.getTime() && b.getTime() === D.getTime()) ? " " + this._dayOverClass : "") +
                                            (W ? " " + this._unselectableClass + " ui-state-disabled" : "") +
                                            (R && !v ? "" : " " + L[1] + (M.getTime() === Q.getTime() ? " " + this._currentClass : "") + (M.getTime() === j.getTime() ? " ui-datepicker-today" : "")) +
                                            "'" +
                                            ((R && !v) || !L[2] ? "" : " title='" + L[2].replace(/'/g, "&#39;") + "'") +
                                            (W ? "" : " data-handler='selectDay' data-event='click' data-month='" + M.getMonth() + "' data-year='" + M.getFullYear() + "'") +
                                            ">" +
                                            (R && !v
                                                ? "&#xa0;"
                                                : W
    ...
    (function (t, e) {
        ...
        f(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', d._handleDismiss(new d())),
                ...
                (E._addTouchEventListeners = function () {
                    ...
                    if (this._touchSupported) {
                        var e = function (t) {
                            ...
                            n = function (t) {
                                i._pointerEvent && F[t.originalEvent.pointerType.toUpperCase()] && (i.touchDeltaX = t.originalEvent.clientX - i.touchStartX),
                                    i._handleSwipe(),
        ...
        f(document).on(L.CLICK_DATA_API, "[data-slide], [data-slide-to]", j._dataApiClickHandler),
        ...
        function yt(t, e, i, n) {
            return Math.max(
                ...
                i["offset" + t],
                i["scroll" + t],
                ft(10) ? parseInt(i["offset" + t]) + parseInt(n["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(n["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0
            );
        }
        function wt(t) {
            var e = t.body,
                            ...
                            return (
                                w.forEach(function (t, e) {
                                    ...
                                    (o || c || f) &&
                                        ...
                                        (g.placement = _ + (y ? "-" + y : "")),
                                        (g.offsets.popper = kt({}, g.offsets.popper, Mt(g.instance.popper, g.offsets.reference, g.placement))),
                        ...
                        fn: function (t, e) {
                            ...
                            var r,
                                ...
                                D =
                                    ...
                                    (y = h ? p : I),
                                    { left: (b = h ? (v || _ || g % 2 == m % 2 ? p : f) : I)(g % 2 == 1 && m % 2 == 1 && !_ && h ? u.left - 1 : u.left), top: y(u.top), bottom: y(u.bottom), right: b(u.right) }),
                            ...
                            if (
                                ((a = "bottom" == T ? ("HTML" === C.nodeName ? -C.clientHeight + D.bottom : -x.height + D.bottom) : D.top),
                                (r = "right" == S ? ("HTML" === C.nodeName ? -C.clientWidth + D.right : -x.width + D.right) : D.left),
                                w && E)
                            )
                                (k[E] = "translate3d(" + r + "px, " + a + "px, 0)"), (k[T] = 0), (k[S] = 0), (k.willChange = "transform");
                            else {
                                var A = "bottom" == T ? -1 : 1,
                                    P = "right" == S ? -1 : 1;
        ...
        function Zt(t, e) {
            ...
            !(function (t) {
                ...
                Object.keys(kt({}, Zt.Defaults.modifiers, n.modifiers)).forEach(function (t) {
        ...
        var te,
            ...
            ge =
                        ...
                        if ((f(n).trigger(i), !i.isDefaultPrevented())) {
                            if (!this._inNavbar && t) {
                                ...
                                "parent" === this._config.reference ? (s = n) : g.isElement(this._config.reference) && ((s = this._config.reference), void 0 !== this._config.reference.jquery && (s = this._config.reference[0])),
                                    ...
                                    (this._popper = new Jt(s, this._menu, this._getPopperConfig()));
                            }
                ...
                (te._getPlacement = function () {
                    ...
                    return (
                        t.hasClass("dropup")
                            ? ((e = "top-start"), f(this._menu).hasClass(ce) && (e = "top-end"))
                ...
                (me._dataApiKeydownHandler = function (t) {
                    if (
                        (/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || (27 !== t.which && ((40 !== t.which && 38 !== t.which) || f(t.target).closest(de).length))) : re.test(t.which)) &&
                        (t.preventDefault(), t.stopPropagation(), !this.disabled && !f(this).hasClass(le))
                    ) {
                    ...
                    if (!this._isShown && !this._isTransitioning) {
                        ...
                        f(this._element).trigger(i),
                            this._isShown ||
                                ...
                                f(this._element).on(ke.CLICK_DISMISS, '[data-dismiss="modal"]', function (t) {
                                    return e.hide(t);
                                }),
            ...
            Ze =
                ...
                (Le.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        f(s).data(this.constructor.DATA_KEY, this),
                            ...
                            (this._popper = new Jt(this.element, s, this._getPopperConfig(a))),
                            f(s).addClass(Ge),
                ...
                (Le.setElementContent = function (t, e) {
                    "object" != typeof e || (!e.nodeType && !e.jquery)
                        ? this.config.html
                            ? (this.config.sanitize && (e = He(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e))
                            : t.text(e)
                        : this.config.html
            ...
            xi =
                ...
                (ui._activate = function (e) {
                    ...
                    i.hasClass("dropdown-item")
                        ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(bi), i.addClass(bi))
                        : (i.addClass(bi),
                          i
                              .parents(yi)
                              .prev(wi + ", " + Ci)
        ...
        function ki(t, e) {
            ...
            (this._element = t),
                ...
                (this._config = this._getConfig(e)),
                (this._selector = this._config.target + " " + wi + "," + this._config.target + " " + Ci + "," + this._config.target + " .dropdown-item"),
                (this._offsets = []),
                (this._targets = []),
                (this._activeTarget = null),
                        ...
                        if ($("#page-container").hasClass("page-sidebar-minified")) {
                            ...
                            if (e) {
                                ...
                                if (
                                    ...
                                    $("#float-sub-menu").css({ top: o, left: r, bottom: "auto", right: a }), $("#float-sub-menu-arrow").css({ top: "20px", bottom: "auto" }), $("#float-sub-menu-line").css({ top: "20px", bottom: "auto" });
                                else {
